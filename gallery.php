...
<div class="header">
	 <div class="container">
		 <div class="logo">
			 <a href="index.php"><h2>&lt;Gallery&gt;</h2></a>
		 </div>
		 <div class="top-menu">
...
<?php	echo "<a href='admin/gupload/$gimage' target='_self' class='inline-block litebox' litebox' data-litebox-group='group-1'><img src='admin/gcatch/$gimage' class='inline-block' /></a> ";?>			
<?php } ?>				
</p>
